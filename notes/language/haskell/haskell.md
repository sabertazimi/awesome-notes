...
- [Monad](./monad.md) - Writer, Reader, State, and Error monads
- [I/O](./io.md) - Input/output, file operations, and ByteString
- [Exception](./exception.md) - Error handling with System.IO.Error
