...
Other `stacking context` are generated by any
[`position`/`opacity`/`transform` element](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Positioning/Understanding_z_index/The_stacking_context)
...
[![Stacking Order](./figures/StackingOrder.png)](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Positioning/Understanding_z_index/Stacking_without_z-index)
