...
- [LibHunt](https://www.libhunt.com):
  Discover awesome open-source projects and their alternatives.
- [BestOfJS](https://github.com/bestofjs/bestofjs):
  Find best components to build amazing web applications.
- [Snyk](https://snyk.io/advisor):
  Find best package for your next project.
- [StarHistory](https://github.com/star-history/star-history):
  Star history graph of GitHub repos.
...
- [Plop](https://github.com/plopjs/plop):
  Micro-generator framework to create files with uniformity.
...
- [URLQueryState](https://github.com/47ng/nuqs):
  Type-safe search params state manager, `useState` but stored in URL query string.
...
- [Effect](https://github.com/Effect-TS/effect):
  Build robust applications in TypeScript.
...
- [Daisy](https://github.com/saadeghi/daisyui):
  Most popular Tailwind components plugin.
- [Elements](https://github.com/mdbootstrap/Tailwind-Elements):
  Tailwind components, sections and templates.
...
- [LineClamp](https://github.com/tailwindlabs/tailwindcss-line-clamp):
  Provides utilities for visually truncating text after fixed number of lines.
- [AspectRatio](https://github.com/tailwindlabs/tailwindcss-aspect-ratio):
  Provides composable API for giving elements fixed aspect ratio.
...
- [Motion](https://github.com/romboHQ/tailwindcss-motion):
  Tailwind animation plugin in TypeScript.
- [Animate](https://github.com/Wombosvideo/tw-animate-css):
  Tailwind animation plugin in CSS.
...
- [Base](https://github.com/mui/base-ui):
...
#### Creative Shadcn UI Framework

- [Bits](https://github.com/DavidHDev/react-bits):
  Animated and interactive components for building memorable websites.
- [Magic](https://github.com/magicuidesign/magicui):
  Animated effects based on ShadCN UI.
- [Cult](https://github.com/nolly-studio/cult-ui):
  Components crafted for design engineers.
- [Eldora](https://github.com/karthikmudunuri/eldoraui):
  UI library for design engineers.

#### Animated Shadcn UI Framework

- [Animate](https://github.com/animate-ui/animate-ui):
  Fully animated, open-source component distribution.
- [Motion](https://github.com/ibelick/motion-primitives):
  UI kit to make beautiful and animated interfaces.
- [ReUI](https://github.com/keenthemes/reui):
  UI components and animated effects.
- [Indie](https://github.com/Ali-Hussein-dev/indie-ui):
  UI components and free shadcn form builder.

#### Styled Shadcn UI Framework

- [8bit](https://github.com/TheOrcDev/8bitcn-ui):
  Retro-designed and accessible components.
- [Retro](https://github.com/Logging-Studio/RetroUI):
  NeoBrutalism styled components.

#### AI Shadcn UI Framework

- [Assistant](https://github.com/assistant-ui/assistant-ui):
  Components for AI chat.
- [PromptKit](https://github.com/ibelick/prompt-kit):
  Core building blocks for AI apps.
- [ElevenLabs](https://github.com/elevenlabs/ui):
  Build multimodal agents faster.

#### Misc Shadcn UI Framework

- [Kibo](https://github.com/shadcnblocks/kibo):
  Composable, accessible and extensible components.
- [Kokonut](https://github.com/kokonut-labs/kokonutui):
  Stunning components built with shadcn/ui and motion.
- [Marketing](https://github.com/tailark/blocks):
  Shadcn marketing blocks.
- [Billing](https://github.com/dodopayments/billingsdk):
  Modern billing and monetization UI components.
- [Tremor](https://github.com/tremorlabs/tremor):
  Build charts and dashboards.
- [MultiSelect](https://github.com/sersavan/shadcn-multi-select-component):
  Multi-select component.

#### Collection Shadcn UI Framework

- [Studio](https://github.com/themeselection/shadcn-studio):
  Collection of copy-and-paste shadcn components, blocks, and templates.
- [Tweak](https://github.com/jnsahaj/tweakcn):
  Visual no-code theme editor for shadcn/ui components.
- [Theme](https://github.com/miketromba/shadcn-themer):
  Create, customize, and share themes for shadcn/ui.
...
- [BluePrint](https://github.com/palantir/blueprint):
  React-based UI toolkit for web.
...
- [Refine](https://github.com/pankod/refine):
  Building internal admin panels, dashboards & B2B apps with unmatched flexibility.
...
- [Viewer](https://github.com/rogden/tailwind-config-viewer):
  Visualize Tailwind configuration.
...
- [Grid](https://github.com/react-grid-layout/react-grid-layout):
...
- [AGGrid](https://github.com/ag-grid/ag-grid):
  Best JavaScript Data Table for building Enterprise Applications.
...
- [InfoGraphic](http://github.com/antvis/infographic):
  Next-generation infographic generation and rendering framework.
...
- [Day](https://github.com/gpbl/react-day-picker):
  Customizable date picker.
- [Date](https://github.com/Hacker0x01/react-datepicker):
  Simple and reusable date picker.
- [Color](https://github.com/argyleink/css-color-component):
  Modern color picker.
...
- [Relative](https://github.com/github/relative-time-element):
  Web component extensions to standard `<time>` element.

### Calendar

- [Schedule](https://github.com/schedule-x/schedule-x):
  Modern event calendar.
- [Full](https://github.com/fullcalendar/fullcalendar)/
...
- [PopIcons](https://github.com/uxthings/popicons):
  Offers line, solid, and duotone icon variants on `20px` grid with `1.5px` stroke.
...
- [DVI2SVG](https://github.com/mgieseki/dvisvgm):
  Fast DVI, EPS, and PDF to SVG converter.
...
- [AdvancedCropper](https://github.com/advanced-cropper/react-advanced-cropper):
  React cropper library that embraces power of advanced cropper core.
...
- [Player](https://github.com/cookpete/react-player):
  React component for playing variety of URLs.
- [Art](https://github.com/zhw2590582/ArtPlayer):
  Modern and full featured HTML5 video player.
...
- [FileType](https://github.com/sindresorhus/file-type):
  Detect file type of Buffer/Uint8Array/ArrayBuffer.
- [FileSize](https://github.com/avoidwork/filesize.js):
  Generate human readable String describing file size.
...
- [YouGet](https://github.com/soimort/you-get):
  Dumb downloader that scrapes web.
...
- [Sequelize](https://github.com/sequelize/sequelize):
  Easy-to-use and promise-based multi SQL dialects ORM.
...
- [DBeaver](https://github.com/dbeaver/dbeaver):
  Free universal database and SQL client.
...
- [Xi](https://github.com/xi-editor/xi-editor):
  Modern editor with backend written in Rust.
...
- [AppSmith](https://github.com/appsmithorg/appsmith):
  Low-code project to build admin panels and dashboards.
...
- [Memos](http://github.com/usememos/memos):
  Self-hosted note-taking service.
...
- [Remark](https://github.com/remarkjs/remark):
  Markdown processor powered by plugins part of `@unifiedjs` collective.
- [StreamDown](https://github.com/vercel/streamdown):
  React markdown designed for AI-powered streaming.
...
- [PM2](https://github.com/Unitech/pm2):
  Node.js production process manager with built-in load balancer.
- [Nodemon](https://github.com/remy/nodemon):
  Monitor for any changes in Node.js application and automatically restart server.

### CLI Input

- [Inquirer](https://github.com/SBoudrias/Inquirer.js):
  Common interactive command line user interfaces collection.
- [Commander](https://github.com/tj/commander.js):
  Node.js command-line interfaces.
- [Yargs](https://github.com/yargs/yargs):
  Modern, pirate-themed successor to optimist.
...
- [Tasuku](https://github.com/privatenumber/tasuku):
  Minimal task visualizer for Node.js.

### CLI Cheat Sheet

- [TLDR](https://github.com/tldr-pages/tldr):
  Help pages for command-line.
...
- [HTTPie](https://github.com/httpie/cli):
  Modern and human-friendly command-line HTTP client for API.
- [XH](https://github.com/ducaale/xh):
  CLI to send HTTP requests written in Rust.
...
- [Better](https://github.com/better-auth/better-auth):
...
- [Cypress](https://github.com/cypress-io/cypress):
  Reliable testing runs in browser.
- [NightWatch](https://github.com/nightwatchjs/nightwatch):
  End to end testing framework using W3C Webdriver API.
...
- [SourceBot](https://github.com/sourcebot-dev/sourcebot):
  Blazingly fast code search deployed as single Docker image.
...
- [ASTGrep](https://github.com/ast-grep/ast-grep):
  Rust CLI for code structural search, lint and rewriting.
...
- [OpenReplay](https://github.com/openreplay/openreplay):
  Session replay.
- [Inspector](https://github.com/antfu/node-modules-inspector):
...
- [Lighthouse](https://github.com/GoogleChrome/lighthouse):
  Automated auditing, performance metrics, and best practices for web.
...
- [Scan](https://github.com/aidenybai/react-scan)
  Scan for React performance issues and eliminate slow renders in app.
...
- [DrawDB](https://github.com/drawdb-io/drawdb):
  Simple and intuitive online database design and SQL generator.
...
- [GitHubScript](https://github.com/actions/github-script):
  Write workflows scripting GitHub API in JavaScript.
...
- [PullRequest](https://github.com/peter-evans/create-pull-request):
  Create pull request for changes to repository in actions workspace.
- [Semantic](https://github.com/amannn/action-semantic-pull-request):
  Ensures that PR title matches Conventional Commits specification.
...
- [PubLint](https://github.com/publint/publint):
  Lint if package is published right.
- [CodeQL](https://github.com/github/codeql-action):
  Running CodeQL analysis.
- [SonarSource](https://github.com/SonarSource/sonarqube-scan-action):
  Scan code with SonarQube.
- [SizeLimit](https://github.com/andresz1/size-limit-action):
  Calculate real cost to run JS app or lib to keep good performance.
- [Fossa](https://github.com/fossas/fossa-action):
  Find license compliance and security issues in applications with FOSSA.
- [Dependency](https://github.com/actions/dependency-review-action):
  Detecting vulnerable dependencies and invalid licenses in PRs.
- [Trivy](https://github.com/aquasecurity/trivy-action):
  Find vulnerabilities, misconfigurations, secrets, and SBOM.
...
- [FumaDocs](https://github.com/fuma-nama/fumadocs):
  Beautiful & flexible React.js docs framework.
...
- [VOCS](https://github.com/wevm/vocs):
  Vite powered React documentation framework.
...
- [Docz](https://github.com/pedronauck/docz):
  React component documentation built on Gatsby.
