...
- 大四喜: 四组风牌刻子.
- 纯正九连宝灯: **(门清)** `1112345678999`, 听牌为任意一张同花色牌.
...
- 接近听牌时 (不再缺少搭子), 可考虑切掉四牌复合型 (四张牌挤占空间) 退回面子, 保留三牌复合型 (两面对/嵌张对/连嵌张), 可以提升直接进张数量.
