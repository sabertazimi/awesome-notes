...
- 进攻信号: 乱序切牌, 切宝牌及其周边, 摸切安全牌, 先切安全牌后切危险牌, 早巡多次跟打字牌或生张役牌.
- 防守信号: 跟打现物, 切面子, 先切危险牌后切安全牌.
- **摸切**: 存在周边牌可能性下降.
- **手切**: 存在周边牌可能性上升 (`-2/+1` 两面听与 `-1/+2` 两面听).
- 早巡多次摸切: 超好型或进张极差.
- 直线乱序切牌: 高打点兼顾防守 (保留边张与字牌作为安全牌).
- 顺序切牌后乱序切牌: 高打点放弃防守.
- 亲家副露, 同巡子家切危险中张: 子家高打点可能.
- 手切一组搭子 (e.g 连续手切 `75`): 搭子超载, 手牌速度较快.
- 手切一组好型搭 (e.g `56` 两面搭): 好型搭超载, 手牌速度较快,
  听两面好型概率很大, 可以利用**筋壁理论**进行防守.
- 手切**唯一**役牌对子: 选择断幺九手役, 手牌速度较快.
