...
- 缺少搭子时, 四连型具有良好**延展性**, 容易形成新的**两面搭**, `4567` -> `34 567` / `45 567`.
...
- 存在愚型搭子时 (容易形成愚型听牌), 可以考虑暂时保留四牌复合型 (不急于固定面子), 寻求好型搭子改良.
...
- **绞杀**策略: 弃和或配弃时, 扣住对手字牌, 阻碍对手作牌, 阻止后附和牌.
