...
- 有相关牌 (+2/-2) 的情况下, 后筋普遍比前筋更安全, 排除愚形能降低筋牌铳率; 对于纯粹的筋, 前筋铳率低于后筋的有筋 28、筋 37、两筋 46、半筋, 前筋铳率高于后筋的有筋 19、两筋 5.
...
- 薄壁 OC 总体通常只能降低 2%~3% 铳率. 紧薄壁 OC (3+0) 铳率大约为 AC (0+0) 的 50%, 隔薄壁 OC (0+3) 铳率大约为 AC (0+0) 的 70%.
